            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-1 col-lg-1">
                    <div class="icon-email">
                        <a href="#" title="Email"><img src="public/images/Home-1/footer-top-icon-l.png" alt="Email" class="img-responsive"></a>
                    </div>
                </div>
            ...
            <div class="row padding-footer-mid">
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="footer-logo text-center list-content">
                        <a href="index.html" title="Skyline"><img src="public/images/Home-1/sky-logo-footer.png" alt="Image"></a>
                    </div>
                </div>
            ...
            <div class="footer-bottom">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 no-padding">
                    <div class="payments text-right">
                        <ul>
                            <li>
                                <a href="#" title="Paypal"><img src="public/images/Home-1/Paypal.png" alt="Paypal"></a>
                            </li>
                            <li>
                                <a href="#" title="Visa"><img src="public/images/Home-1/Visa.png" alt="Visa"></a>
                            </li>
                            <li>
                                <a href="#" title="Master"><img src="public/images/Home-1/Master-card.png" alt="Master"></a>
                            </li>
                            <li>
                                <a href="#" title="Discover"><img src="public/images/Home-1/Discover.png" alt="Discover"></a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<script type="text/javascript" src="public/js/vit-gallery.js"></script>
<script type="text/javascript" src="public/js/jquery.countTo.js"></script>
<script type="text/javascript" src="public/js/jquery.appear.min.js"></script>
...
<script type="text/javascript" src="public/js/jquery.littlelightbox.js"></script>
...
<!-- Custom jQuery -->
<script type="text/javascript" src="public/js/sky.js"></script>
</body>


<!-- Mirrored from landing.engotheme.com/html/skyline/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 10:51:08 GMT -->
